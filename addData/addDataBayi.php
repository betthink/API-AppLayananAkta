...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $insert = "INSERT INTO databayi VALUES (NULL, '$Nama', '$JenisKelamin', '$TempatPersalinan', '$TempatKelahiran', '$DateKelahiran', '$TimeKelahiran', '$UrutanKelahiran', '$PenolongBayi', '$BeratBayi', '$PanjangBayi',0, '$IdUser')";
    // var_dump($insert); die;
